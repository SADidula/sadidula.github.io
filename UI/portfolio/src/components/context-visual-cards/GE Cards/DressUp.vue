<template>
    <div class="p-4">
        <div class="row">
            <div class="col-6">
                <h3 class="fw-bold pb-3">👗 Dress Up</h3>
                <p>
                    <span class="fw-bold">
                        Overview:
                    </span>
                ...
                <ul>
                    <li>
                        🧩 Support Mechanics: Implemented and fine-tuned systems for resource collection, inventory
                        management, and item usage, ensuring they felt intuitive and rewarding.
                    </li>
                    <li>
                        🎮 Level Design: Designed and iterated multiple levels with escalating challenges and clear
                        goals to keep players engaged and motivated to progress.
                    </li>
                    <li>
                        🔍 Playtesting & Balancing: Conducted tests via Google Play to identify balancing issues, gather
                        player feedback, and fine-tune pacing and progression.
                    </li>
                    <li>
                        👗 Audience Focus: Contributed ideas to align the game’s mechanics and visual flow with a style
            ...
            <div class="col-6">
                ...
                <div class="row">
                    ...
                    <ul>
                        <li>
                            ✅ Successfully tested on Google Play with a playable version, ensuring core mechanics and
                    ...
                    <p>
                        ...
                        the target audience’s expectations. I also gained practical experience refining gameplay loops
